...
public class OLDMainActivity extends SherlockFragmentActivity implements
		ActionBar.OnNavigationListener, OnRefreshListener<ScrollView>,
		ShutdownDialogListener {
	private static final Logger LOGGER = LoggerFactory
			.getLogger(OLDMainActivity.class);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// init intents
		settingsIntent = new Intent(OLDMainActivity.this, SettingsActivity.class);
		newRaspiIntent = new Intent(OLDMainActivity.this, NewRaspiActivity.class);
		editRaspiIntent = new Intent(OLDMainActivity.this, EditRaspiActivity.class);
